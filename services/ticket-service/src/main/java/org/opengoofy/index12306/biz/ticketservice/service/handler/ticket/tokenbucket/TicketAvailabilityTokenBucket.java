...
public final class TicketAvailabilityTokenBucket {
    ...
    public void rollbackInBucket(TicketOrderDetailRespDTO requestParam) {
        ...
        Long result = stringRedisTemplate.execute(actual, Lists.newArrayList(actualHashKey), JSON.toJSONString(seatTypeCountArray), JSON.toJSONString(takeoutRouteDTOList));
