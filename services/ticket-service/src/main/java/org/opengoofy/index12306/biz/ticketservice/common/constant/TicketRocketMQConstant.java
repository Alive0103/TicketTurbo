...
public final class TicketRocketMQConstant {
     ...
     * 用户异步购票 Topic Key
     */
    public static final String PURCHASE_TICKET_ASYNC_TOPIC_KEY = "index12306_ticket-service_purchase-ticket-async_topic${unique-name:}";

    /**
     * 用户异步购票消费者组 Key
     */
    public static final String PURCHASE_TICKET_ASYNC_CG_KEY = "index12306_ticket-service_purchase-ticket-async_cg${unique-name:}";
}
