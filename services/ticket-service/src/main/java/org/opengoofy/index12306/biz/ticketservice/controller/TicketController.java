...
import org.opengoofy.index12306.biz.ticketservice.dto.resp.OrderTrackingRespDTO;
...
public class TicketController {
     ...
     * 购买车票v3
     */
    @PostMapping("/api/ticket-service/ticket/purchase/v3")
     ...
     * 购买车票v3查询订单结果
     */
    @GetMapping("/api/ticket-service/ticket/purchase/v3/query")
