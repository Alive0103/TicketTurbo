...
public final class RedisKeyConstant {
     ...
     * 列车站点路线集合 Key
     */
    public static final String LIST_TRAIN_STATION_ROUTE_KEY = "index12306-ticket-service:list_train_station_route:%s_%s_%s";

    /**
     * 列车出售站点路线集合 Key
     */
    public static final String LIST_TAKEOUT_TRAIN_STATION_ROUTE_KEY = "index12306-ticket-service:list_takeout_train_station_route:%s_%s_%s";

    /**
     * 列车站点关系 Key
     */
    public static final String TRAIN_STATION_RELATION_KEY = "index12306-ticket-service:train_station_relation:%s_%s_%s";
}
